...
library BTCUtils {
    ...
    function determineOutputLength(bytes _b) public pure returns (uint256) {
        ...
        // P2WSH
        // Any of these could be faked by having an OP_RETURN that's a specific number of bytes such that it fulfills one of these conditions
    ...
    function extractOutputAtIndexTest(bytes _b, uint8 _index) public pure returns (bytes) {
